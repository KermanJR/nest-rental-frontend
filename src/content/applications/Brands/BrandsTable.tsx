...
const BrandsTable: FC<RecentOrdersTableProps> = ({ cryptoOrders}) => {
  ...
  const exportFile = useCallback(() => {
    const newData = cryptoOrders.map(item => ({
      "Nome Marca": item.nome,
      "ID Marca": item.identificador
    }))
    ...
    <Card>
      ...
      <TableContainer>
        <Table>
          ...
          <TableBody>
            {paginatedCryptoOrders.map((marca) => {
                  ...
                  <TableCell padding="checkbox">
                    <Checkbox
                      ...
                      onChange={(event: ChangeEvent<HTMLInputElement>) =>
                        handleSelectOneCryptoOrder(event, marca.id)
                      }
                  ...
                  <TableCell align="right">
                    <Tooltip title="Editar Marca" arrow>
                      <IconButton
                        ...
                        color="inherit"
                        size="small"
                        onClick={(e)=>queryBrandById(marca.id)}
                      >
