...
const RegisterCategoryTable: FC<RecentOrdersTableProps> = ({ productOrders }) => {
    ...
    <Card>
      ...
      <TableContainer>
        <Table>
          ...
          <TableBody>
            {paginatedCryptoOrders.map((productOrder) => {
                  ...
                  <TableCell padding="checkbox">
                    <Checkbox
                      ...
                      onChange={(event: ChangeEvent<HTMLInputElement>) =>
                        handleSelectOneCryptoOrder(event, productOrder.id)
                      }
...
RegisterCategoryTable.propTypes = {
  productOrders: PropTypes.array.isRequired
};

RegisterCategoryTable.defaultProps = {
  productOrders: []
};

export default RegisterCategoryTable;
