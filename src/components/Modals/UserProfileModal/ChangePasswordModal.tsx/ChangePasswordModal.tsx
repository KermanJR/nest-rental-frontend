...
export const ChangePasswordModal = ({openModal, setModal, data, edit}: ModalPropsTestEdit) => {
  ...
  async function changePassword(event: React.FormEvent<HTMLFormElement>){
    ...
    setEditedPassword(dataJson.descricao)
    ...
    <>
      {openModal && (
        <div className={styles.modalCategory}>
          ...
          <form onSubmit={edit && changePassword}>
            <div style={{marginTop: '1rem'}}>
              ...
              <input 
                ...
                value={edit? editedPassword: newPassword}
                onChange={
                  edit? (e)=>setEditedPassword(e.target.value): (e)=>setNewPassword(e.target.value)}
